...
int					ft_process_quote_content_double(char *line, int len,
						int pos, t_token **head);
int					ft_process_quote_content_sim(char *line, int len, int pos,
						t_token **head);
int					ft_process_word(char *line, int len, int pos,
						t_token **head);
